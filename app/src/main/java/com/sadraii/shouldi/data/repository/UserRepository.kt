...
class UserRepository(private val userDao: UserDao, private val userFirebaseDataStore: UserFirebaseDataStore) {
    ...
    internal suspend fun getUser(user: String?) = userFirebaseDataStore.getUser(user)

    internal suspend fun getUser(firebaseUser: FirebaseUser) = getUser(firebaseUser.uid)
